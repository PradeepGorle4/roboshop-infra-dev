module "mysql_sg" {
    ...
    sg_name = "mysql"
    sg_description = "Created for MySQL instances in roboshop dev"
...
module "bastion_sg" {
    ...
    environment = var.environment
    sg_name = "bastion"
    sg_description = "Created for bastion instances in roboshop dev"
    vpc_id = data.aws_ssm_parameter.vpc_id.value
    common_tags = var.common_tags
}
...
module "vpn_sg" {
    ...
    environment = var.environment
    sg_name = "vpn"
    sg_description = "Created for VPN instances in roboshop dev"
    vpc_id = data.aws_ssm_parameter.vpc_id.value
    common_tags = var.common_tags
}
...
module "alb_ingress_sg" {
    ...
    environment = var.environment
    sg_name = "app-alb"
    sg_description = "Created for backend ALB in roboshop dev"
    vpc_id = data.aws_ssm_parameter.vpc_id.value
    common_tags = var.common_tags
}
